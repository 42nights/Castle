  ...
  return (
    <div className="digest-body">
      <ReactMarkdown
        ...
        components={{
          h1: ({ children }) => (
            <h2 className="font-display text-[28px] font-normal leading-[1.15] tracking-[-0.015em] text-ink mt-10 mb-3 first:mt-0"
              style={{ fontFamily: "var(--font-display, Georgia, serif)", fontVariationSettings: '"opsz" 96, "SOFT" 50, "WONK" 0' }}>
              {children}
            </h2>
          ),
          h2: ({ children }) => (
            <h2 className="text-[20px] font-normal leading-[1.2] tracking-[-0.015em] text-ink mt-8 mb-2 first:mt-0"
              style={{ fontFamily: "var(--font-display, Georgia, serif)", fontVariationSettings: '"opsz" 96, "SOFT" 50, "WONK" 0' }}>
              {children}
            </h2>
          ),
          ...
          p: ({ children }) => (
            <p className="text-[16px] leading-[1.65] text-ink mb-5 last:mb-0">
              {children}
            </p>
          ),
          ul: ({ children }) => (
      ...
      <div className="max-w-[720px] mx-auto px-6 pt-24 pb-20">
        ...
        <div className="flex items-start justify-between mb-10">
          ...
          <div className="flex items-center gap-2 mt-1 shrink-0">
            ...
            <Button
              ...
              size="sm"
              onClick={sendToSlack}
              aria-label="Send brief to Slack"
            >
        ...
        <footer className="mt-12 pt-6 border-t border-line">
          <p className="t-caption text-ink-3">
            Digest generated {generatedTime}. Source: Castle + Hermes.
          </p>
        </footer>
      </div>
    );
  ...
  return (
    <div className="max-w-[720px] mx-auto px-6 pt-24 pb-20 flex flex-col items-center text-center">
      ...
      <p className="text-[16px] text-ink-2 leading-[1.6] mb-8 max-w-[400px]">
        No brief generated yet today. Run it to see your calendar, open
        follow-ups, and Castle attention items.
      </p>
      <Button
        onClick={generate}
        disabled={generating}
